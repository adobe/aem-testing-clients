...
/**
 * Wraps the TextImage foundation component, providing methods for editing it. See {@code
...
public class TextImage extends AbstractFoundationComponent {
  ...
  public SlingHttpResponse uploadImage(String mimeType, String imageName, String resourcePath)
    ...
    client.doPost(
        componentPath + PROP_IMAGE_NODE_NAME, testImage.getCreateFormEntity(null).build());
