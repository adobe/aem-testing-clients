...
/**
 * Base class for all Foundation Component wrapping objects. Foundation components can be found at
 * /libs/foundation/components in the CQ repository.<br>
 * <br>
 * The subclasses provide methods to manipulate the according component but does not store or cache
 * any component data to avoid inconsistencies. The only information stored with the client is path
 * info.
 */
public abstract class AbstractFoundationComponent extends AbstractComponent {
   ...
   */
  public AbstractFoundationComponent(
