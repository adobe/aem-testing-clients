...
public class ExperienceFragmentsClient extends CQClient {
  ...
  private static final String WEB_TEMPLATE_PATH =
      "/libs/settings/experience-fragments/templates/experience-fragment-template";
  private static final String FACEBOOK_TEMPLATE_PATH =
      "/libs/settings/experience-fragments/templates/experience-fragment-template-facebook";
  private static final String PINTEREST_TEMPLATE_PATH =
      "/libs/settings/experience-fragments/templates/experience-fragment-template-pinterest";
  // private static final String POS_TEMPLATE_PATH =
  // "/libs/settings/experience-fragments/templates/experience-fragment-template-pos";
  ...
  private static final String PROPERTIES_PATH_PREFIX =
  ...
  private static final String REFERENCES_SERVLET =
      "/libs/cq/experience-fragments/content/commons/reference.json";
  private static final String CONFIGURATOR =
      "/libs/cq/experience-fragments/content/dialogs/configdialog/configurator.html";
  ...
  public interface XFTemplate {
    ...
    /**
     * A {@link VariantComponents} subclass object that can be used to configure the components
     ...
     * @return A {@link VariantComponents} subclass object that can be used to configure the
     *     components defined in that template
     */
    <T extends VariantComponents> T getComponents(
  ...
  /**
   * Base class for classes mapped to predefined templates that enable consumers to configure
   * variant components from that template
   */
    ...
    CUSTOM {
      ...
      public String path() {
        throw new UnsupportedOperationException(
            "Cannot determine path for custom templates through Enum");
      }
  ...
  private static final String XF_CREATE_WIZARD =
      "/libs/cq/experience-fragments/content/v2/experience-fragments/createxfwizard/_jcr_content";
  private static final String XF_VARIANT_CREATE_WIZARD =
      "/libs/cq/experience-fragments/content/dialogs/createvariation/creator";

  private static final String CONVERT_TO_XF =
      "/libs/cq/experience-fragments/content/v2/conversion/converter";

  public ExperienceFragmentsClient(CloseableHttpClient http, SlingClientConfig config)
      throws ClientException {
    super(http, config);
  }

  public ExperienceFragmentsClient(URI serverUrl, String user, String password)
      throws ClientException {
   ...
   */
  public ExperienceFragmentBuilder experienceFragmentBuilder(
      String xfTitle, String variantTitle, String variantTemplate) {
   ...
   */
  public ExperienceFragmentBuilder experienceFragmentBuilder(
      String xfTitle, String variantTitle, XF_TEMPLATE variantTemplate) {
   ...
   */
  public SlingHttpResponse createExperienceFragment(
      String xfTitle, String variantTitle, String variantTemplate, int... expectedStatus)
      throws ClientException {
    return new ExperienceFragmentBuilder(this, xfTitle, variantTitle, variantTemplate)
   ...
   */
  public SlingHttpResponse createExperienceFragment(
      String xfTitle, String variantTitle, XF_TEMPLATE variantTemplate, int... expectedStatus)
      throws ClientException {
   ...
   */
  public ExperienceFragmentVariantBuilder xfVariantBuilder(
      String parentPath, String template, String title) {
   ...
   */
  public ExperienceFragmentVariantBuilder xfVariantBuilder(
      String parentPath, XF_TEMPLATE template, String title) {
   ...
   * @throws ClientException if the request fails
   */
  public SlingHttpResponse createXfVariant(
      String parentPath, String template, String title, int... expectedStatus)
      throws ClientException {
    return new ExperienceFragmentVariantBuilder(this, parentPath, template, title)
        .create(expectedStatus);
  }
   ...
   */
  public SlingHttpResponse createXfVariant(
      String parentPath, XF_TEMPLATE template, String title, int... expectedStatus)
      throws ClientException {
    return createXfVariant(parentPath, template.path(), title, expectedStatus);
  }

  /**
   * Create a Live Copy of an Experience Fragment Variant The new variant will be created under the
   * same Experience Fragment
   *
   ...
   * @param expectedStatus http status expected after creation of the experience fragment variant
   *     live copy
   * @return The full {@link SlingHttpResponse} for the experience fragment variant live copy create
   *     request
   * @throws ClientException if the request fails
   */
  public SlingHttpResponse createVariationAsLiveCopy(
      String sourceVariantPath,
      String title,
      String name,
      String[] rolloutConfigs,
      int... expectedStatus)
      throws ClientException {
    return wcmCommands.createLiveCopy(
        name,
        title,
        getParentXFPath(sourceVariantPath),
        sourceVariantPath,
        true,
        rolloutConfigs,
        null,
   ...
   * @throws ClientException if the request fails
   */
  public SlingHttpResponse deleteExperienceFragment(String path, int... expectedStatus)
      throws ClientException {
   ...
   * @throws ClientException if the request fails
   */
  public SlingHttpResponse deleteExperienceFragment(
      String path, boolean force, int... expectedStatus) throws ClientException {
    HttpEntity entity =
   ...
   * @throws ClientException if the request fails
   */
  public SlingHttpResponse deleteXfVariant(String variantPath, int... expectedStatus)
      throws ClientException {
    HttpEntity entity =
        FormEntityBuilder.create().addParameter("variationPath", variantPath).build();

    return doPost(
        getParentXFPath(variantPath) + "/jcr:content.deletevariation.json",
        entity,
   ...
   * @param expectedStatus http status expected after calling the the Plain Html Processor for the
   *     variant
   * @return The full {@link SlingHttpResponse} for the experience fragment variant plain html
   *     processor request. The HTML rendition can be obtained by calling {@code
   *     SlingHttpResponse.getContent()} method
   * @throws ClientException if the request fails
   */
  public SlingHttpResponse getPlainHtmlRendering(String variantPath, int... expectedStatus)
      throws ClientException {
    return doGet(
        variantPath + ".plain.html", HttpUtils.getExpectedStatus(HttpStatus.SC_OK, expectedStatus));
  }
   ...
   * @param expectedStatus http status expected after requesting the social urls for the social
   *     variant
   * @return The full {@link SlingHttpResponse} after requesting the social urls for the social
   *     variant The Social Urls are in JSON format and can be obtained by calling {@code
   *     SlingHttpResponse.getContent()} method
   * @throws ClientException if the request fails
   */
  public SlingHttpResponse getSocialUrls(String variantPath, int... expectedStatus)
      throws ClientException {
    return doGet(
        variantPath + ".socialurls.json",
        HttpUtils.getExpectedStatus(HttpStatus.SC_OK, expectedStatus));
  }
  ...
  public SlingHttpResponse getXFPropertiesPageHTHML(String xfPath, int... expectedStatus)
      throws ClientException {
  ...
  private List<String> getPageReferences(String pagePath) throws ClientException {
    ...
    JsonArray references =
        GSON.fromJson(content.getContent(), JsonObject.class).get("assets").getAsJsonArray();
  ...
  private SlingHttpResponse replicate(String cmd, String pagePath, int... expectedStatus)
      throws ClientException {
    FormEntityBuilder form =
        FormEntityBuilder.create()
            .addParameter("_charset_", "UTF-8")
  ...
  public SlingHttpResponse unpublish(String pagePath, int... expectedStatus)
      throws ClientException {
    return replicate("Deactivate", pagePath);
  }

  public SlingHttpResponse publishXFVariant(String variantPath, int... expectedStatus)
      throws ClientException {
  ...
  public SlingHttpResponse unpublishXFVariant(String variantPath, int... expectedStatus)
      throws ClientException {
  ...
  /**
   * Get the path of the parent Experience Fragment, given the path of the Experience Fragment
   * Variant
   *
   * @param variantPath the path of the Experience Fragment Variant
  ...
  /**
   * A {@link VariantComponents} subclass object that can be used to configure the variant
   * components defined in the template
   *
   * @param variantPath the path of the Experience Fragment Variant
   * @param template the template of the Experience Fragment Variant
   * @param <T> The subclass of {@link VariantComponents} to which the result should be casted to
   * @return A {@link VariantComponents} subclass object that can be used to configure the variant
   *     components defined in the template
   * @throws Exception if the components can not be retrieved
   */
  public <T extends VariantComponents> T getComponents(String variantPath, XF_TEMPLATE template)
      throws Exception {
  ...
  public class ExperienceFragmentBuilder {
     ...
     */
    public ExperienceFragmentBuilder(
     ...
     *
     * @param expectedStatus http status expected after sending the Experience Fragment create
     *     request
     * @return The full {@link SlingHttpResponse} for the experience fragment create request
     * @throws ClientException if the request fails
     */
    public SlingHttpResponse create(int... expectedStatus) throws ClientException {
      FormEntityBuilder entityBuilder =
          FormEntityBuilder.create()
  ...
  public static class ExperienceFragmentVariantBuilder {
     ...
     */
    public ExperienceFragmentVariantBuilder(
        ExperienceFragmentsClient client, String parentPath, String template, String title) {
      this.client = client;
      this.parentPath = parentPath;
     ...
     *
     * @param expectedStatus http status expected after sending the Experience Fragment Variant
     *     create request
     * @return The full {@link SlingHttpResponse} for the experience fragment variant create request
     * @throws ClientException if the request fails
     */
  ...
  public static class ConvertToXFAction {
     ...
     * @throws ClientException if the request fails
     */
    public SlingHttpResponse createNewExperienceFragment(
      ...
      FormEntityBuilder entityBuilder =
          FormEntityBuilder.create()
              ...
              .addParameter(
                  "xfParentPath", parentPath != null ? parentPath : DEFAULT_XF_PARENT_PATH)
              .addParameter("pageTitle", xfTitle)
              .addParameter("variantTemplate", variantTemplate)
              .addParameter("variantTitle", variantTitle);
    ...
    public SlingHttpResponse createNewExperienceFragment(
        ...
        int... expectedStatus)
        throws ClientException {
      return createNewExperienceFragment(
          componentPath,
          parentPath,
          xfTitle,
          xfTags,
          variantTitle,
          variantTemplate.path(),
          variantTags,
          expectedStatus);
    }
     ...
     * @throws ClientException if the request fails
     */
    public SlingHttpResponse addToAnExistingXF(
        String componentPath,
        String parentXFPath,
        String variantTitle,
        String variantTemplate,
  ...
  public static class ImageComponent extends Component {
    ...
    public ImageComponent(ExperienceFragmentsClient client, String variantPath, String pathSuffix) {
      ...
      this.imageComponentPath =
          variantPath + (StringUtils.isBlank(pathSuffix) ? IMAGE_COMPONENT_PATH_SUFIX : pathSuffix);
    }

    public SlingHttpResponse setImageReference(String imagePath, int... expectedStatus)
        throws ClientException {
      FormEntityBuilder form =
          FormEntityBuilder.create()
              .addParameter("_charset_", "UTF-8")
  ...
  public static class TextComponent extends Component {
    ...
    public TextComponent(ExperienceFragmentsClient client, String variantPath, String pathSuffix) {
      ...
      this.textComponentPath =
          variantPath + (StringUtils.isBlank(pathSuffix) ? TEXT_COMPONENT_PATH_SUFIX : pathSuffix);
    }
  ...
  public static class ContentFragmentComponent extends Component {
    ...
    public ContentFragmentComponent(
        ExperienceFragmentsClient client, String variantPath, String pathSuffix) {
      super(client, variantPath);

      contentFragmentComponentPath =
          variantPath
  ...
  /**
   * Representation of the Experience Fragment NOTE: All properties are cached. If any change is
   * made in the repository you need to call {@code ExperienceFragment.update()}.
   */
  public static class ExperienceFragment {
    ...
    public ExperienceFragment(ExperienceFragmentsClient client, String xfPath)
        throws ClientException {
      this.client = client;
    ...
    private void buildXF() throws ClientException {
      JsonObject experienceFragment =
          GSON.fromJson(
              client.doGet(xfPath + ".1.json", HttpStatus.SC_OK).getContent(), JsonObject.class);
      xfProperties = experienceFragment.getAsJsonObject("jcr:content");
      title = xfProperties.get(TITLE_PROP).getAsString();
      description =
          xfProperties.get(DESCRIPTION_PROP) != null
              ? xfProperties.get(DESCRIPTION_PROP).getAsString()
              : null;
      //noinspection unchecked
      tags =
          xfProperties.get(TAGS_PROP) != null
              ? (List<String>)
                  GSON.fromJson(
                      xfProperties.get(TAGS_PROP).getAsJsonArray().toString(), LIST_STRING_TYPE)
              : null;
      facebookSpace =
          xfProperties.get(FACEBOOK_SPACE_PROP) != null
              ? xfProperties.get(FACEBOOK_SPACE_PROP).getAsString()
              : null;
      pinterestSpace =
          xfProperties.get(PINTEREST_SPACE_PROP) != null
  ...
  /**
   * Representation of the Experience Fragment Variant NOTE: All properties are cached. If any
   * change is made in the repository you need to call {@code ExperienceFragmentVariant.update()}.
   */
  public static class ExperienceFragmentVariant {
    ...
    private void buildVariant() throws ClientException {
      ...
      description =
          variantProperties.get(DESCRIPTION_PROP) != null
              ? variantProperties.get(DESCRIPTION_PROP).getAsString()
              : null;
      //noinspection unchecked
      tags =
          variantProperties.get(TAGS_PROP) != null
              ? (List<String>)
                  GSON.fromJson(
                      variantProperties.get(TAGS_PROP).getAsJsonArray().toString(),
                      LIST_STRING_TYPE)
              : null;
      facebookSpace =
          variantProperties.get(FACEBOOK_SPACE_PROP) != null
              ? variantProperties.get(FACEBOOK_SPACE_PROP).getAsString()
              : null;
      pinterestSpace =
          variantProperties.get(PINTEREST_SPACE_PROP) != null
              ? variantProperties.get(PINTEREST_SPACE_PROP).getAsString()
              : null;

      //noinspection unchecked
      List<String> mixins =
          variantProperties.get(MIXIN_TYPES_PROP) != null
              ? (List<String>)
                  GSON.fromJson(
                      variantProperties.get(MIXIN_TYPES_PROP).getAsJsonArray(), LIST_STRING_TYPE)
    ...
    public void setFacebookSpace(String facebookSpace) throws ClientException {
      if (templateType != XF_TEMPLATE.FACEBOOK)
        throw new UnsupportedOperationException(
            "Cannot set the Facebook Space for a non Facebook variant");
    ...
    public void setPinterestSpace(String pinterestSpace) throws ClientException {
      if (templateType != XF_TEMPLATE.PINTEREST)
        throw new UnsupportedOperationException(
            "Cannot set the Facebook Space for a non Pinterest variant");
  ...
  /**
   * Representation the configuration of the Experience Fragments Feature, as it can be done from
   * the UI NOTE: All properties are cached. If any change is made in the repository you need to
   * call {@code ExperienceFragmentsConfiguration.update()}.
   */
  public static class ExperienceFragmentsConfiguration {
    ...
    public ExperienceFragmentsConfiguration(ExperienceFragmentsClient client)
        throws ClientException {
      this.client = client;
      buildConfiguration();
    }
    ...
    private void buildConfiguration() throws ClientException {
      SlingHttpResponse response =
          client.doGet(ExperienceFragmentsClient.DEFAULT_XF_PARENT_PATH + ".json");
      JsonObject folderProperties = GSON.fromJson(response.getContent(), JsonObject.class);
      JsonArray allowedTemplatesJson =
          folderProperties.get(ALLOWED_TEMPLATES_PROP).getAsJsonArray();
  ...
  public static class ExperienceFragementsConfigurationBuilder {
     ...
     * @throws ClientException if the builder cannot be created
     */
    public ExperienceFragementsConfigurationBuilder(ExperienceFragmentsClient client)
        throws ClientException {
      this.client = client;
     ...
     * @return this
     */
    public ExperienceFragementsConfigurationBuilder withAllowedTemplates(
    ...
    public ExperienceFragmentsConfiguration configure() throws ClientException {
       ...
       */
      List<String> allowedTemplatesResolved =
          allowedTemplates != null ? allowedTemplates : configuration.getAllowedTemplates();
