...
/**
 * The base client for all form-related actions. It provides a core set of commonly used
 * foundation/form functions such as post. <br>
 * <br>
...
public class FormClient extends CQClient {
   ...
   */
  public SlingHttpResponse doFormPost(
      String path,
    ...
    for (int i = 1 /* start at 1 to skip prelude before first form_error */;
        i < parts.length;
        i++) {
  ...
  private static Collection<String> subtract(
