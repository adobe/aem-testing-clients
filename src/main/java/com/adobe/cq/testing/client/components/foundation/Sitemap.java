...
/**
 * Wraps the Sitemap foundation component, providing methods for editing it. See {@code
 * /libs/foundation/components/sitemap} in the repository for implementation details.
 */
