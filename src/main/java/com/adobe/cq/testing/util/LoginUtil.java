...
public class LoginUtil {
   ...
   */
  public static HttpResponse doGetWithLoginToken(
      String loginToken, CQClient cqClient, String testPage) throws IOException {
   ...
   */
  public static <T extends AbstractSlingClient> HttpPost buildFormAuthPost(
      T graniteClient, String user, String pass, String page) {
    // create post request
