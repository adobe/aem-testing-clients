...
/**
 * Wraps the Table foundation component, providing methods for editing it. See {@code
 * /libs/foundation/components/table} in the repository for implementation details.
 */
