...
public class CommerceClient extends FormClient {
    ...
    public SlingHttpResponse addProductAsset(String product, String asset) throws ClientException {
        ...
        return this.doPost("/etc/scaffolding/we-retail/product/jcr:content/cq:dialog/content/items/columns/items/column1/items/images/image.create.html", form.build(), SC_OK);
    ...
    public SlingHttpResponse updateProductAsset(String productAssetPath, String newAsset) throws ClientException {
        ...
        return this.doPost("/etc/scaffolding/we-retail/product/jcr:content/cq:dialog/content/items/columns/items/column1/items/images/image.update.html", form.build(), SC_OK);
    ...
    public SlingHttpResponse deleteProductAsset(String productAssetPath) throws ClientException {
        ...
        return this.doPost("/etc/scaffolding/we-retail/product/jcr:content/cq:dialog/content/items/columns/items/column1/items/images/image.remove.html", form.build(), SC_OK);
