...
/**
 * Wraps the Flash foundation component, providing methods for editing it. See {@code
 * /libs/foundation/components/flash} in the repository for implementation details.
 */
public class Flash extends AbstractFoundationComponent {
   ...
   */
  public SlingHttpResponse uploadAnimation(
      String mimeType, String fileName, String resourcePath, int... expectedStatus)
    ...
    return client.doPost(
        componentPath, saveEntity, HttpUtils.getExpectedStatus(SC_OK, expectedStatus));
  }
   ...
   * @throws ClientException If something fails during request/response cycle
   */
  public SlingHttpResponse uploadAltImage(
      String mimeType, String imageName, String resourcePath, int... expectedStatus)
    ...
    HttpEntity saveEntity =
        FormEntityBuilder.create()
            .addParameter(
                "./" + PROP_IMAGE_FILE_MOVE_FROM, componentPath + "/" + PROP_IMAGE_FILE_TMP)
            .addParameter(PROP_UNDO_BLOBS, componentPath + "/" + PROP_FILE)
            .build();
