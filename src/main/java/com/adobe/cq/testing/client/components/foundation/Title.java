...
/**
 * Wraps the Title foundation component, providing methods for editing it. See {@code
 * /libs/foundation/components/title} in the repository for implementation details.
 */
