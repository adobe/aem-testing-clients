...
/**
 * Wraps the Image foundation component, providing methods for editing it. See {@code
 * /libs/foundation/components/image} in the repository for implementation details.
 */
public class Image extends AbstractFoundationComponent {
   ...
   */
  public SlingHttpResponse uploadImage(
