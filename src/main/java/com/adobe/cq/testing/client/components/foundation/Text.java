...
/**
 * Wraps the Text foundation component, providing methods for editing it. See {@code
 * /libs/foundation/components/text} in the repository for implementation details.
 */
