...
public class Group extends AbstractAuthorizable {
   ...
   */
  public SlingHttpResponse addMembers(Authorizable[] authorizables, int... expectedStatus)
   ...
   * @throws ClientException If something fails during request/response cycle
   */
  public SlingHttpResponse addMember(Authorizable authorizable, int... expectedStatus)
      throws ClientException {
   ...
   */
  public boolean hasGroupMember(Authorizable authorizable)
      throws ClientException, InterruptedException {
   ...
   * @throws InterruptedException to mark this method as "waiting"
   */
  public static <T extends SecurityClient> Group createGroup(
      T client,
      String groupId,
