...
public class Util {
   ...
   *
   * <p>Could be optimized by checking the URL and if it's a file on disk to get the file size
   * directly. The code tries to be general though, and the assets uploaded should be small.
   *
   ...
   * @throws ClientException Thrown if the content-length of the HTTP response doesn't match
   *     expected
   */
  // TODO: Contribute to org.apache.sling.testing.clients.SlingHttpResponse
  public static void checkContentLength(SlingHttpResponse response, long expected)
   ...
   * @throws ClientException Thrown if the content-disposition of the HTTP response doesn't match
   *     expected
   */
  // TODO: Contribute to org.apache.sling.testing.clients.SlingHttpResponse
  public static void checkContentDisposition(SlingHttpResponse response, String expected)
      throws ClientException {
    ...
    if (headers == null || headers.length == 0) {
      ...
      throw new ClientException(
          response
              + " has more than 1 content disposition ("
