...
/**
 * Wraps the Adaptive Image foundation component, providing methods for editing it. See {@code
 * /libs/foundation/components/adaptiveimage} in the repository for implementation details.
 */
