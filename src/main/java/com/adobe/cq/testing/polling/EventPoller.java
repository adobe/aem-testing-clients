 ...
 *
 * <p>Can either be used via the checkEventOccurrence() class method or by instantiating an
 * eventPoller and calling the callUntilCondition() method.
 */
public class EventPoller extends Polling {
  ...
  public static long getLatestEventTimestamp(SlingClient client) throws ClientException {
    ...
    JsonNode eventData =
        JsonUtils.getJsonNodeFromString(client.doGet(EVENT_URL, SC_OK).getContent());
   ...
   */
  public static boolean checkEventOccurrence(
      SlingClient client, String topic, String path, long since) throws InterruptedException {
